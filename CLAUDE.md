...
**Climb API surface (Phase 3b + A011 + A019):**
- `GET /api/climbs/search?q=&angle=&grade_min=&grade_max=&min_ascents=&min_quality=&moves=&sort=` → search with filters; `moves` is the A019 bucket (`any` | `le5` | `6-7` | `8-10` | `gt10`). Animated sequences (`frames_count > 1`) are excluded globally regardless of filters.
...
**Version:** 2.25 (A020 Clerk auth integration 2026-05-07)
