...
│   ├── lib/            api.ts (Clerk JWT per call, 401-retry-once) · clerk.d.ts · grades.ts · ble/(kilter-protocol · kilter-board-service · transport)
│   ├── data/           placements_12x12.json + leds_12x12.json (generated by backend/scripts/regenerate_board_assets.py)
│   └── layout.tsx · globals.css (Tailwind v4) · safe-area.css (.pt-safe/.pb-safe/.pb-nav)
├── components/         BoardMap · ClimbBoardView · ClimbCard · StateIcons · LogSection · RecentLogs · FilterPanel · GradeDisplay · StarRating · BottomNav · ClimbBleControls · ClerkSpaProvider · AuthGuard
