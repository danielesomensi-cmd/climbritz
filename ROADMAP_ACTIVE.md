...
**Status:** ✅ Merged to main (2026-05-08, PR #1 b918e35 + hotfix PR #2 a0f799d) — Android device verification ✅ green (2026-05-10) + Railway env vars confirmed ✅ — iOS device verification + Vercel env vars still pending.
