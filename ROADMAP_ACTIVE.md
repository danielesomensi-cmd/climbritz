...
- [ ] **v2 (prossimo brief, ID next-free — il brief lo chiama "A028")** — tap-on-hold editor, "Start from blank", rename sezione homepage → "AI Create"; più grade-coherence scoring (needs HC-7 grip difficulty), grip-type filtering, foot remix
