...
| Climb detail | `discover/detail/page.tsx` | Board visualization + BLE control bar (A015). Reuses `/ble-test` BLE stack via `ClimbBleControls` + `climb-to-leds.ts` |
...
*Architecture doc created: March 2026 (B002) — Last updated: 23 April 2026 (A015)*
