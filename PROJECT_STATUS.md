...
> **Ultimo aggiornamento: 31 Maggio 2026** — Release mobile pre-Reddit: Android build 9 + iOS build 5 cut da `main`. + (30 Mag) B021 Clerk Production + email/password su Android **e** iOS; fix analisi video Gemini (`thinking_budget=0`). Dettagli sotto.
