...
> **Ultimo aggiornamento: 4 Giugno 2026** — B032 launch polish (web, diretto a `main`): un solo brand-orange `#ff6b35`, `/classify` IT→EN, account/sign-out in homepage, BottomNav su upload/dashboard/videos-detail. + (31 Mag) Release mobile pre-Reddit: Android build 9 + iOS build 5 cut da `main`. + (30 Mag) B021 Clerk Production + email/password su Android **e** iOS; fix analisi video Gemini (`thinking_budget=0`). Dettagli sotto.
