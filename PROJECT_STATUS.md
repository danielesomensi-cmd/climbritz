...
| A020 Clerk auth integration | ✅ Done | Replaces legacy custom-JWT auth. 14 commits on feat/a019-clerk-auth. iOS WKAppBoundDomains + Capacitor allowNavigation set up for Clerk widget in WebView (B-medium). Pending: Phase 4 device verification, Railway/Vercel env var setup, merge. |
